...
Histograma                                                                                             & 31\% \\
T. de Fourier                                                                                          & 30\% \\
P. da Borda + Cor Predominante                                                                         & 60\% \\
P. da Borda + Histograma                                                                               & 31\% \\
P. da Borda + T. de Fourrier                                                                           & 30\% \\
Cor Predominante + Histograma                                                                          & 53\% \\
Cor Predominante + T. de Fourrier                                                                      & 52\% \\
Histograma + T. de Fourrier                                                                            & 50\% \\
\begin{tabular}[c]{@{}l@{}}P. da Borda + Cor Predominante \\ + Histograma\end{tabular}                 & 53\% \\
\begin{tabular}[c]{@{}l@{}}P. da Borda + Cor Predominante \\ + T. de Fourrier\end{tabular}             & 52\% \\
\begin{tabular}[c]{@{}l@{}}P. da Borda + Histograma\\ + T. de Fourrier\end{tabular}                    & 30\% \\
\begin{tabular}[c]{@{}l@{}}P. da Borda + Cor Predominante\\ + T. de Fourrier\end{tabular}              & 52\% \\
\begin{tabular}[c]{@{}l@{}}P. da Borda + Histograma\\ + Cor Predominante + T. de Fourrier\end{tabular} & 52\%
\end{tabular}
\end{table}
